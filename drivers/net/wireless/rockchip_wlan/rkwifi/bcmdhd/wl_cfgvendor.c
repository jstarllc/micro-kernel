...
//EJM - didn't exist
// static int wl_cfgvendor_significant_change_cfg(struct wiphy *wiphy, struct wireless_dev *wdev, const void  *data, int len)
...
// EJM **  THIS WAS IN THE OLD KERNEL BUT DOESN'T EVEN EXIST IN THIS ONE
//
//static int
